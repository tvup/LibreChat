export enum QueryKeys {
  ...
  adminConversationStats = 'adminConversationStats',
  adminFiles = 'adminFiles',
  adminFileStats = 'adminFileStats',
  adminSessions = 'adminSessions',
  adminViolations = 'adminViolations',
  adminSystemInfo = 'adminSystemInfo',
  adminEndpointStats = 'adminEndpointStats',
  adminMCPServers = 'adminMCPServers',
  adminMCPStats = 'adminMCPStats',
  adminTokenStats = 'adminTokenStats',
  adminModels = 'adminModels',
  adminSocialMappings = 'adminSocialMappings',
}
...
export enum MutationKeys {
  ...
  adminDeleteConversation = 'adminDeleteConversation',
  adminDeleteFile = 'adminDeleteFile',
  adminRevokeSessions = 'adminRevokeSessions',
  adminReinitializeMCP = 'adminReinitializeMCP',
  adminBulkBan = 'adminBulkBan',
  adminBulkDelete = 'adminBulkDelete',
  adminBulkRole = 'adminBulkRole',
  adminInviteUser = 'adminInviteUser',
  adminToggleModel = 'adminToggleModel',
  adminBulkModels = 'adminBulkModels',
  adminCreateSocialMapping = 'adminCreateSocialMapping',
  adminDeleteSocialMapping = 'adminDeleteSocialMapping',
}
